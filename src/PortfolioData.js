const portfolioData = {
  ...
  aboutMe:
    "I am a self-taught Web Developer, currently diving deeper into Javascript through React with the intention of learning and applying more. I believe that to be successful in life, one needs to be obsessive with their dreams and keep working towards them.",
  skills: [
    {
      skillName: "HTML5",
      skillLevel: 85,
